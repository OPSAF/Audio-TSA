...
def generate_report_plots(analysis_results, output_dir='outputs'):
    ...
    try:
        ...
        print(f"Warning: Failed to generate waveform plot: {e}")
    ...
    try:
        ...
        print(f"Warning: Failed to generate FFT plot: {e}")
    ...
    try:
        ...
        print(f"Warning: Failed to generate STFT spectrogram: {e}")
    ...
    try:
        ...
        print(f"Warning: Failed to generate Mel spectrogram: {e}")
    ...
    try:
        ...
        print(f"Warning: Failed to generate MFCC plot: {e}")
    ...
    try:
        ...
        print(f"Warning: Failed to generate ACF/PACF plot: {e}")
    ...
    try:
        ...
        print(f"Warning: Failed to generate periodicity plot: {e}")
    ...
    try:
        # band_summary format: {band_key: {name, avg_rmse, ...}}
        # band_results format: {band_key: {info, predictions}}
        if 'band' in analysis_results and isinstance(analysis_results['band'], dict):
            band_data = analysis_results['band']
            if 'summary' in band_data:
                plot_band_errors(band_data['summary'],
                                 os.path.join(output_dir, 'band_errors.png'))
            if 'results' in band_data:
                plot_band_error_bars(band_data['results'],
                                     os.path.join(output_dir, 'band_error_bars.png'))
        elif 'band_summary' in analysis_results:
            # Legacy flat structure
            plot_band_errors(analysis_results['band_summary'],
                             os.path.join(output_dir, 'band_errors.png'))
    except Exception as e:
        print(f"Warning: Failed to generate band error plots: {e}")
